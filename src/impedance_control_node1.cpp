#include <impedance_control/impedance_control_node1.h>
...
ImpedanceControl::ImpedanceControl(int rate)
{
    ...
    mraic_status_pub_[0] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/force_x/status", 1);
    mraic_status_pub_[1] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/force_y/status", 1);
    mraic_status_pub_[2] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/force_z/status", 1);
    mraic_status_pub_[3] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/torque_x/status", 1);
    mraic_status_pub_[4] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/torque_y/status", 1);
    mraic_status_pub_[5] = n_.advertise<impedance_control::MRAIController>("impedance_control/mraic/torque_z/status", 1);
...
{
    int i;
    impedance_control::MRAIController mraic_status_msg;
...
void ImpedanceControl::modes_cb(const impedance_control::Modes &msg)
{
